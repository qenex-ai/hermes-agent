...
- **[IDE Integration (ACP)](acp.md)** — Use Hermes inside ACP-compatible editors such as VS Code, Zed, and JetBrains. Chat, tool activity, file diffs, and terminal commands render inside your editor. Cursor is not an ACP host for Hermes — use [Hermes MCP in Cursor](/guides/cursor-mcp) instead.
