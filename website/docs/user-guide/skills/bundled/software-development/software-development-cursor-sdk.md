---
title: "Cursor Sdk — Run Cursor SDK agents with prompt, send, or resume"
...
Run Cursor SDK agents with prompt, send, or resume.
...
| Path | `skills/software-development/cursor-sdk` |
| Version | `1.0.0` |
| Author | Hermes Agent |
| License | MIT |
